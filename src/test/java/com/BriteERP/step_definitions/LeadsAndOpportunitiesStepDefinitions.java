...
public class LeadsAndOpportunitiesStepDefinitions {
    ...
    public void user_goes_to_leads_and_opportunities() {
        ...
        Assert.assertTrue(crMpage.lead_And_Opportunities.isDisplayed());
    }
    ...
    public void user_clicks_on_lead_tags() {
        ...
        Assert.assertTrue(leads_and_opportunitiesPage.leadTags.isDisplayed());
    }
    @When("user clicks on Lost Reasons")
    public void user_clicks_on_Lost_Reasons() {

      wait.until(ExpectedConditions.elementToBeClickable(leads_and_opportunitiesPage.LostReasons)).click();
        Assert.assertTrue(leads_and_opportunitiesPage.LostReasons.isDisplayed());
    }
    ...
    public void user_should_be_able_to_click_on_create() {
        ...
        Assert.assertTrue(leads_and_opportunitiesPage.create.isDisplayed());
    ...
    public void user_should_create_a_name_using(String name) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(leads_and_opportunitiesPage.name)).sendKeys(name);
        Assert.assertTrue(leads_and_opportunitiesPage.name.isDisplayed());
    ...
    public void user_should_save_the_name() {
        ...
        Assert.assertTrue(leads_and_opportunitiesPage.save.isDisplayed());

    }

    @Given("user should click on action dropdown")
    public void user_should_click_on_action_dropdown() {
       wait.until(ExpectedConditions.elementToBeClickable(leads_and_opportunitiesPage.action)).click();
        Assert.assertTrue(leads_and_opportunitiesPage.action.isDisplayed());
